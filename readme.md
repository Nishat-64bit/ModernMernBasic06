    ------------------------------------------------------------------    
                know about js basic 06  string  method  <Start>
    -------------------------------------------------------------------
            ///
        ...
        let url2 = url.split("/");  // jekono kicu dia split korte paren , : | 
    ...
    ------------------------------------------------------------------    
                know about js basic 06  string method  <End>
    -------------------------------------------------------------------

     ------------------------------------------------------------------    
                know about js basic 06  Array  method  <Start>
    ------------------------------------------------------------------- 
    
    ------------------------------------------------------------------    
                know about js basic 06  Array method  <End>
    -------------------------------------------------------------------